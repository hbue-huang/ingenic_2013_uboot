				...
				int clk_id, unsigned int freq)
{
	...
	if (aif_id > 0 && aif_id <= 2 && aif_id <= ARRAY_SIZE(wm8994->sysclk) + 1)  /* SECURITY: bounds check */ if (aif_id > 0 && aif_id <= 2) wm8994->sysclk[aif_id - 1] = clk_id; /* SECURITY FIX-524: Bounds check */ /* SECURITY FIX: Bounds check */
